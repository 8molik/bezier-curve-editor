...
def draw_buttons():
    ...
    draw_button(button_z_rect, "Delete Point")
    draw_button(button_x_rect, "Delete Curve")
    draw_button(button_space_rect, "Add Curve")
    draw_button(button_c_rect, "Angle")
    draw_button(button_print_rect, "Print Curves")
    if remove_flag:
        draw_button(button_remove_point_rect, "Delete Points", True)
    else:
        draw_button(button_remove_point_rect, "Delete Points")
    draw_button(button_connect_rect, "Join")
